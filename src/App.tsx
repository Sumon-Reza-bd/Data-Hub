          ...
          >
            ...
            >
              ...
              <button 
                ...
                className="w-full max-w-xs mx-auto py-4 bg-white text-indigo-600 rounded-2xl font-black uppercase tracking-widest shadow-xl hover:bg-indigo-50 transition-all active:scale-95"
              >
                Continue
              </button>
            </motion.div>
